# Stored Procedure: sp_GMF_JD_UsoCFC_Total

## Usa los objetos:
- [[GMF_CFC]]
- [[GMF_JD_UsoCFC_Total]]
- [[GMF_JD_UsoCFCTotales]]
- [[v_GMF_1_JD_ValoresVentasNetas]]

```sql


CREATE PROCEDURE [dbo].[sp_GMF_JD_UsoCFC_Total]
@anio varchar(5), @mes varchar(5), @CodPresentacion varchar(5)

AS
BEGIN

truncate table GMF_JD_UsoCFC_Total
truncate table [dbo].[GMF_JD_UsoCFCTotales]
...
select distinct * from GMF_JD_UsoCFC_Total

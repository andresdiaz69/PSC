# Stored Procedure: sp_Descargos_SolicitudByEmpleado
...
CREATE PROC [dbo].[sp_Descargos_SolicitudByEmpleado]
(
	@IdDescargo BIGINT
) AS
...
BEGIN
	...
	SELECT DISTINCT 
		...
		E.FechaNacimientoEmpleado,	E.FechaIngresoEmpleado,
	...
	(
		...
		SELECT 	E.CedulaEmpleado,								E.NombreEmpleado,									CodCargoEmpleado=E.CodCargo,				
				...
				FechaNacimientoEmpleado = E.FechaNacimiento,	FechaIngresoEmpleado = E.FechaIngresoCompañia

# Stored Procedure: sp_ExcesosExcesivos_ExcesosExcesivos18
...
CREATE procedure [dbo].[sp_ExcesosExcesivos_ExcesosExcesivos18]

    @Year as int,  
    @Month as int,
    --@LNOFCNMB_IdsConceptos AS nvarchar(100), -- IDS DE LOS CONCEPTOS SEPARADOS POR ;
	@CodMarca AS nvarchar(50)
...
ExcesoExcesivo,ValorExceso,ValorExcesoExcesivo,ValorTotal
...
from(
		...
		from(
			...
			from(
				...
				VentasMes2, VentasMes3, VentasMes4, VentasMes5, VentasMes6, VentasMes7, VentasMes8, VentasMes9, VentasMes10, VentasMes11, VentasMes12, VentasMes13, VentasMes14, VentasMes15, VentasMes16,
				VentasMes17, VentasMes18, VentasTotal, Stock, PrecioMedio, UndPteRecibir, PrecioVenta, IdDescuentos, FechaUltimaVenta, FechaUltimaCompra, Total12Meses, Total6Meses,Q,Exceso,
				ExcesoExcesivo = case when (Exceso - ((Total12Meses + Total6Meses)/2)) < 0 then  0 else (Exceso - ((Total12Meses + Total6Meses)/2))  end,ValorExceso = Exceso*PrecioMedio
				from(
					...
					Exceso = case when (stock - ((Total12Meses + Total6Meses) * l.tiempo)) < 0 then 0 else (stock - ((Total12Meses + Total6Meses) * l.tiempo)) end

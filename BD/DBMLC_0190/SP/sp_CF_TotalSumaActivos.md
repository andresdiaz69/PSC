# Stored Procedure: sp_CF_TotalSumaActivos
...
CREATE PROC [dbo].[sp_CF_TotalSumaActivos] 
	@FechaConsulta DATE,
	@FechaIngreso DATE
AS
BEGIN
	...
	FROM	[CF_Datos] X WHERE X.Fecha = @FechaConsulta AND X.N1 < @N1 AND X.N2 = 0 AND X.N3 = 0

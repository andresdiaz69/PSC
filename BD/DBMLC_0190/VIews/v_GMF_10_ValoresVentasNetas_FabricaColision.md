# View: v_GMF_10_ValoresVentasNetas_FabricaColision
...
```sql
CREATE view [dbo].[v_GMF_10_ValoresVentasNetas_FabricaColision] as
...
from(
		...
		where i.CodigoPresentacion in (28,29)
		--and i.año2 = 2020
		...
		left join [InformesComiteDB].dbo.vw_InformesSedesCentros	s	on	(case when a.CodigoPresentacion in (1,6,7,8,9,12,28,87,88) then 1 else 6 end) = s.empresa
																			...
																			and s.tipo in ('Fabrica','Fábrica','Colision','Colisión')

# View: v_Provision_Comisiones_ComisionVehiculos
...
```sql
CREATE view [dbo].[v_Provision_Comisiones_ComisionVehiculos] as
Select CodigoPresentacion,Año,Mes,CodigoConcepto,NombreConcepto,Sede,Valor
from(
		...
		where i.CodigoPresentacion in (3,5,6,7,8,9,12,17)
		--and i.año2 = 2020
		--and i.mesfinal2 in (5)
		and i.Balance = 17
		and i.MesFinal1 <> MesFinal2
		and i.CodigoConcepto IN (350)
		union all
		select i.CodigoPresentacion,Año=i.Año2,Mes=i.MesFinal2,i.CodigoConcepto,i.NombreConcepto,

# View: v_Provision_Comisiones_Comisiones_PagadasJD
...
CREATE view [dbo].[v_Provision_Comisiones_Comisiones_PagadasJD] as
select Año,mes,Empresa,NombreEmpresa,Centro,a.nombrecentro,seccion,a.NombreSeccion,Cuenta,
TipoSeccion = case when a.NombreSeccion like '%Wirtgen%' then 'WIRTGEN'
					when a.NombreSeccion like '%constr%'  then 'JD Construccion'
					else isnull(n.NombreUnidadNegocio,'JD Agricola')
					end,
Saldo=sum(Saldo)
from(
...
)a left join UnidadDeNegocio n	on	a.empresa = n.CodEmpresa and a.Centro = n.CodCentro and a.Seccion = n.CodSeccion
where a.nombrecentro like 'JD%'
group by año,mes,Empresa,NombreEmpresa,Centro,a.nombrecentro,seccion,a.NombreSeccion,Cuenta,n.NombreUnidadNegocio

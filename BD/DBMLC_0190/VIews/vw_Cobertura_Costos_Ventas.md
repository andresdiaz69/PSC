# View: vw_Cobertura_Costos_Ventas
...
CREATE VIEW vw_Cobertura_Costos_Ventas AS 
Select distinct a.CodigoPresentacion,a.NombrePresentacion,Año=Año2,MesInicial=MesInicial2,MesFinal = MesFinal2,
CodigoConcepto,NombreConcepto,Sede,s.CodigoCentro,s.NombreCentro,a.valor as 'costoVentasMesActual'
from(
...
and s.NombreCentro not like 'BN-%'
and a.CodigoPresentacion  in (3,5,6,7,8,9,11,12,17,72,73,74,83,119,120,121)
--AND a.CodigoPresentacion=83
--and a.MesInicial2=1
--and a.MesFinal2=9
--and a.Año2=2020

# View: vw_RepuestosV2_VendedoresBoutiques_3_Detalle
...
CREATE VIEW [dbo].[vw_RepuestosV2_VendedoresBoutiques_3_Detalle]
AS
...
AND 
--(dbo.vw_ComisionesSpigaTallerPorOTBodegueroPorVendedorCTMM.CodClas1 IN ('ROPA','1','40','ACC','21','34','BOUT','ACCE'))
(dbo.vw_ComisionesSpigaTallerPorOTBodegueroPorVendedorCTMM.Seccion LIKE '%bout%') -- JCS: 2022/11/08 - SOLICITADO POR MARIA DEL PILAR 
AND

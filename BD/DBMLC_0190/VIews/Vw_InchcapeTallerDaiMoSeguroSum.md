# View: Vw_InchcapeTallerDaiMoSeguroSum
...
```sql
Create view Vw_InchcapeTallerDaiMoSeguroSum as
...
select distinct año=year(FechaFactura),
       ...
       ValorMO =  CONVERT(BIGINT,ISNULL(f.ImporteVARBruto,0))     + CONVERT(BIGINT,ISNULL(f.ImportePINTAceptada,0))+
				  ...
				  CONVERT(BIGINT,ISNULL(f.ImporteSUBAceptada,0))  + CONVERT(BIGINT,ISNULL(f.ImporteSUBBruto,0))   -

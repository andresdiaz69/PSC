# View: vw_PorcentajeRecaudoVNFacturaFull
...
- [[VehiculosVIN]]
- [[vw_ComisionesSpigaVNFactura_Pre]]
...
CREATE VIEW [dbo].[vw_PorcentajeRecaudoVNFacturaFull]
AS
...
MAX(NombreCliente) AS NombreCliente
						  ...
						  FROM            dbo.vw_ComisionesSpigaVNFactura_Pre
						 ...
						 ON RESULTADO.CodigoEmpresaSugerido = dbo.ComisionesSpigaNotasCredito.CodigoEmpresaSugerido 

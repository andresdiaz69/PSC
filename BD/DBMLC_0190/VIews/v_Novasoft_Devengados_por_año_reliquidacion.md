# View: v_Novasoft_Devengados_por_año_reliquidacion
...
```sql
CREATE view [dbo].[v_Novasoft_Devengados_por_año_reliquidacion] as
select año=year(fec_liq),mes=month(fec_liq),ano_liq,per_liq,
...
Valor=sum(val_liq),FechaIngreso=Fecha_Ingreso,FechaRetiro=Fecha_Retiro
from(		
		...
		Fecha_Ingreso=e.fec_ing,Fecha_Retiro=e.fec_egr
		...
		where  l.val_liq <> 0
		and l.nat_liq = 1
		--and year(l.fec_liq)=2019
		--and l.cod_cia=22
		and month(fec_liq) <> l.per_liq
		...
		g3.codigo,g3.nombre,o.cod_cco,o.nom_cco,l.cod_cl1,g1.nombre,l.cod_cl2,g2.nombre,r.cod_car,r.nom_car,e.fec_ing,e.fec_egr
 ...
 Departamento,Nombre_departamento,codigo_Cargo,Nombre_cargo,cod_con,nom_con,Fecha_Ingreso,Fecha_Retiro,ano_liq,per_liq

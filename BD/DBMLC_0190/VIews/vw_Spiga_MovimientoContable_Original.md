# View: vw_Spiga_MovimientoContable_Original
...
```sql
CREATE view [dbo].[vw_Spiga_MovimientoContable_Original] as
...
CuentaBancaria,Marca,NombreMarca
from(​
...
--where Empresa = 6
--and FechaAsiento >= '20190701'
--and FechaAsiento <= '20190731'

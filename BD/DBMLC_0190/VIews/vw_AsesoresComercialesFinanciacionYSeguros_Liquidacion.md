# View: vw_AsesoresComercialesFinanciacionYSeguros_Liquidacion

## Usa los objetos:
- [[vw_AsesoresComercialesFinanciacionYSeguros_1]]
- [[vw_AsesoresComercialesFinanciacionYSeguros_2]]
- [[vw_EmpleadosDetalle]]
...
CREATE VIEW [dbo].[vw_AsesoresComercialesFinanciacionYSeguros_Liquidacion] AS
...
(
	...
	FROM vw_AsesoresComercialesFinanciacionYSeguros_1 AS A
	FULL JOIN vw_AsesoresComercialesFinanciacionYSeguros_2 AS B ON

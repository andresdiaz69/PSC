...
```sql
CREATE VIEW [dbo].[vw_TallerAsesoresMM_2]
AS
...
WHERE        (dbo.ComisionesSpigaTallerPorOT.TipoOperacion <> 'MAT') AND (dbo.ComisionesSpigaTallerPorOT.TipoIntCargo = 'C' OR
                         dbo.ComisionesSpigaTallerPorOT.TipoIntCargo = 'I' OR
                         dbo.ComisionesSpigaTallerPorOT.TipoIntCargo = 'S')

# View: vw_JefedePlaneacionyDesarrollodeProductoMITyBYD_Liquidacion

## Usa los objetos:
- [[Centros]]
- [[vw_EmpleadosDetalle]]
- [[vw_JefedePlaneacionyDesarrollodeProductoMITyBYD_11]]

```sql

CREATE VIEW [dbo].[vw_JefedePlaneacionyDesarrollodeProductoMITyBYD_Liquidacion] AS
...
(
	...
	FROM vw_JefedePlaneacionyDesarrollodeProductoMITyBYD_11 AS A
)AS T

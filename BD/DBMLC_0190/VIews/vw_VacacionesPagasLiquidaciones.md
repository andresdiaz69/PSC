# View: vw_VacacionesPagasLiquidaciones
...
```sql
CREATE view [dbo].[vw_VacacionesPagasLiquidaciones] as
--Vacaciones pagadas en contratos de trabajo hasta el año y mes que se está consultando

select CedulaEmpleado,NombreEmpleado,FechaLiquidacion,CodigoConcepto,NombreConcepto,can_liq=sum(can_liq),Val_liq=sum(val_liq),
CodigoCompania,NombreCompania,CodigoMarca,NombreMarca,CodigoCentro,NombreCentro,CodigoSeccion,NombreSeccion,CodigoDepartamento,NombreDepartamento,
...
from(
		...
		where v.cod_con = '001146'
		--and year(v.fec_liq)=2021
		--and month(v.fec_liq)=12
		--and v.cod_emp = '52393173'
)a group by CedulaEmpleado,NombreEmpleado,FechaLiquidacion,CodigoConcepto,NombreConcepto,
CodigoCompania,NombreCompania,CodigoMarca,NombreMarca,CodigoCentro,NombreCentro,CodigoSeccion,NombreSeccion,CodigoDepartamento,NombreDepartamento,
CodigoUnidadNegocio,NombreUnidadNegocio,CodigoSede,NombreSede

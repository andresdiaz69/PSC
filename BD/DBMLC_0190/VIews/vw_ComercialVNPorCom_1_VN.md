# View: vw_ComercialVNPorCom_1_VN
...
CREATE VIEW [dbo].[vw_ComercialVNPorCom_1_VN]
AS
...
FROM            (SELECT        dbo.vw_PorcentajeRecaudoVNFactura.Ano_Recaudo, dbo.vw_PorcentajeRecaudoVNFactura.Mes_Recaudo, dbo.vw_PorcentajeRecaudoVNFactura.CodigoEmpresa, dbo.vw_PorcentajeRecaudoVNFactura.Empresa, 
                                                    ...
                                                    dbo.vw_PorcentajeRecaudoVNFactura.ImporteEfecto, dbo.vw_PorcentajeRecaudoVNFactura.PorcentajeRecaudo, dbo.ComisionesSpigaVN.PrecioLista, dbo.ComisionesSpigaVN.CodigoMArca, dbo.ComisionesSpigaVN.Marca, 

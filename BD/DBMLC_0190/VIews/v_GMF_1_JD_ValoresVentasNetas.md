# View: v_GMF_1_JD_ValoresVentasNetas
...
CREATE view [dbo].[v_GMF_1_JD_ValoresVentasNetas] as
Select distinct Empresa=1,a.CodigoPresentacion,p.nombrepresentacion,Año,Mes,CodigoConcepto,NombreConcepto,Sede,--s.CodigoCentro,s.NombreCentro,s.NombreSeccion,
Valor
from(
		...
		and i.CodigoConcepto in (4,18,52,53)
		union all
		select i.CodigoPresentacion,Año=i.Año2,Mes=i.MesFinal2,i.CodigoConcepto,i.NombreConcepto,

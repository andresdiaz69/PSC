# View: vw_ComisionesSpigaTallerPorOTBodegueroPorVendedorCTMM_SinNC_Original
...
CREATE VIEW [dbo].[vw_ComisionesSpigaTallerPorOTBodegueroPorVendedorCTMM_SinNC_Original]
AS

# View: vw_JefeDeVentasDaimlerCll13_4

## Usa los objetos:
- [[Empleados]]
- [[EmpleadosRangosMaestras]]
- [[vw_JefeDeVentasDaimlerCll13_41]]
...
CREATE VIEW [dbo].[vw_JefeDeVentasDaimlerCll13_4]
AS
...
FROM            (SELECT        dbo.vw_JefeDeVentasDaimlerCll13_41.Ano_Periodo, dbo.vw_JefeDeVentasDaimlerCll13_41.Mes_Periodo, dbo.vw_JefeDeVentasDaimlerCll13_41.CodigoEmpleado,
                                                    EMPLEADO.IdRangoMaestra, EMPLEADO.IdRangoVersionMax, EMPLEADO.IdComisionModeloSub, EMPLEADO.IdComisionModeloSubCriterio, dbo.vw_JefeDeVentasDaimlerCll13_41.EficienciaAdministrativa
                          FROM            (SELECT        dbo.Empleados.CodigoEmpleado, dbo.vw_RangosVersionesMaxSub.IdRangoMaestra, dbo.vw_RangosVersionesMaxSub.IdRangoVersionMax, dbo.vw_RangosVersionesMaxSub.IdComisionModeloSub, 
                                                    ...
                                                    WHERE        (dbo.vw_RangosVersionesMaxSub.IdComisionModeloSub = 50) AND (dbo.vw_RangosVersionesMaxSub.IdComisionModeloSubCriterio = 94)) AS EMPLEADO LEFT OUTER JOIN
                                                    dbo.vw_JefeDeVentasDaimlerCll13_41 ON EMPLEADO.CodigoEmpleado = dbo.vw_JefeDeVentasDaimlerCll13_41.CodigoEmpleado) AS EFICIENCIA_ADMINISTRATIVA LEFT OUTER JOIN
                         dbo.vw_RangosMaestrasFull ON EFICIENCIA_ADMINISTRATIVA.IdRangoVersionMax = dbo.vw_RangosMaestrasFull.IdRangoVersion
WHERE        (dbo.vw_RangosMaestrasFull.IdComisionModeloSub = 50) AND (dbo.vw_RangosMaestrasFull.IdComisionModeloSubCriterio = 94) AND 

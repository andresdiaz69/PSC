# View: v_Provision_Comisiones_cartera_RepuestosJD
...
CREATE  view [dbo].[v_Provision_Comisiones_cartera_RepuestosJD] as -- se debe tener en cuenta que debe ser hasta el mes anterior

# View: vw_JefeNacionalDeRepuestosBonaparte_Liquidacion

## Usa los objetos:
- [[vw_EmpleadosDetalle]]
- [[vw_JefeNacionalDeRepuestosBonaparte_1]]
- [[vw_RangosMaestrasFull]]

```sql

CREATE VIEW [dbo].[vw_JefeNacionalDeRepuestosBonaparte_Liquidacion] AS
...
(
	...
	FROM vw_JefeNacionalDeRepuestosBonaparte_1 AS A

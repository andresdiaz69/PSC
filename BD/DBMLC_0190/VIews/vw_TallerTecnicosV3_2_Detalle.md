# View: vw_TallerTecnicosV3_2_Detalle
...
CREATE VIEW [dbo].[vw_TallerTecnicosV3_2_Detalle]
AS
SELECT        dbo.ComisionesSpigaTallerPorOT.Ano_Periodo, dbo.ComisionesSpigaTallerPorOT.Mes_Periodo, 
						 ...
						 SUM(CASE WHEN (dbo.ComisionesSpigaTallerPorOT.FkTarifaTaller IN ('1')) then dbo.ComisionesSpigaTallerPorOT.UnidadesVendidas end) AS UnidadesVendidas_Elevado,
...
HAVING        (dbo.vw_RangosVersionesMaxSub.IdComisionModeloSub = 94) AND (dbo.vw_RangosVersionesMaxSub.IdComisionModeloSubCriterio = 176)

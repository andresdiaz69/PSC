# View: vw_VacacionesPagadasDinero
...
```sql
CREATE view [dbo].[vw_VacacionesPagadasDinero] as
--Vacaciones pagadas en dinero hasta el año y mes que se está consultando

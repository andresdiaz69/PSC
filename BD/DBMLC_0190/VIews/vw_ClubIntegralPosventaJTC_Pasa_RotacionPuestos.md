# View: vw_ClubIntegralPosventaJTC_Pasa_RotacionPuestos
...
```sql
CREATE VIEW [dbo].[vw_ClubIntegralPosventaJTC_Pasa_RotacionPuestos] AS
...
where vm.IdRangoMaestra ='45' and t.CodigoMarca='12' and Resultado='pasa'
...
select r.CodigoEmpleado,t.Nombres,t.CodigoMarca,t.Marca,r.IdCLubIntegralModeloSub,t.NombreModeloSub,r.Ano,r.Trimestre,r.RotacionPuestos,vm.IdRangoMaestra,vm.IdRangoVersionMax
from ClubIntegralJefeDeTaller r 
left join vw_ClubIntegralPosventaJT_Ticket        t		 on	r.CodigoEmpleado = t.CodigoEmpleado	and r.Trimestre = t.Trimestre
left join vw_ClubIntegralRangoMaestrasVersionMax  vm	 on	r.CodigoEmpleado = vm.CodigoEmpleado
where vm.IdRangoMaestra ='46' and t.CodigoMarca='19' and Resultado='pasa'
...
left join vw_ClubIntegralPosventaJT_Ticket        t		 on	r.CodigoEmpleado = t.CodigoEmpleado	and r.Trimestre = t.Trimestre
left join vw_ClubIntegralRangoMaestrasVersionMax  vm	 on	r.CodigoEmpleado = vm.CodigoEmpleado
where vm.IdRangoMaestra ='47' and t.CodigoMarca='22' and Resultado='pasa'
...
left join vw_ClubIntegralPosventaJT_Ticket        t		 on	r.CodigoEmpleado = t.CodigoEmpleado	and r.Trimestre = t.Trimestre
left join vw_ClubIntegralRangoMaestrasVersionMax  vm	 on	r.CodigoEmpleado = vm.CodigoEmpleado
where vm.IdRangoMaestra ='48' and t.CodigoMarca='2' and Resultado='pasa'
...
left join vw_ClubIntegralPosventaJT_Ticket        t		 on	r.CodigoEmpleado = t.CodigoEmpleado	and r.Trimestre = t.Trimestre
left join vw_ClubIntegralRangoMaestrasVersionMax  vm	 on	r.CodigoEmpleado = vm.CodigoEmpleado
where vm.IdRangoMaestra ='49' and t.CodigoMarca='20' and Resultado='pasa'

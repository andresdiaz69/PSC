# View: vw_RepuestosV2_VendedoresDeTienda_3_Detalle
...
CREATE VIEW [dbo].[vw_RepuestosV2_VendedoresDeTienda_3_Detalle]
AS
...
AND
(dbo.vw_ComisionesSpigaTallerPorOTBodegueroPorVendedorCTMM.TipoIntCargo NOT IN ('G', 'GA', 'I'))
AND

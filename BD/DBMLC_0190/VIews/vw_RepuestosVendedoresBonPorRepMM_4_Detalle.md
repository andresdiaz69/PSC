# View: vw_RepuestosVendedoresBonPorRepMM_4_Detalle
...
CREATE VIEW [dbo].[vw_RepuestosVendedoresBonPorRepMM_4_Detalle]
AS
SELECT        INDIVIDUAL.Ano_Periodo, INDIVIDUAL.Mes_Periodo, INDIVIDUAL.CodigoEmpresa, INDIVIDUAL.CedulaVendedorRepuestos, INDIVIDUAL.NumeroFactura, INDIVIDUAL.CumplimientoAl15_AL, 
                         INDIVIDUAL.CodigoSede, INDIVIDUAL.NombreSede, INDIVIDUAL.Presupuesto, SEDE.CumplimientoAl15_AL_Sede
FROM            (SELECT        dbo.vw_ComisionesSpigaAlmacenAlbaranBodegueroPorVendedor.Ano_Periodo, dbo.vw_ComisionesSpigaAlmacenAlbaranBodegueroPorVendedor.Mes_Periodo, 
                                                    ...
                                                    AS CumplimientoAl15_AL, dbo.Sedes.CodigoSede, dbo.Sedes.NombreSede, dbo.ExogenasPresupuestos.Presupuesto
                          ...
                          WHERE        
						  (DATEPART(DAY, dbo.vw_ComisionesSpigaAlmacenAlbaranBodegueroPorVendedor.FechaFactura) <= 15)
						  --AND (dbo.vw_ComisionesSpigaAlmacenAlbaranBodegueroPorVendedor.FechaFactura <= '20191031' OR dbo.vw_ComisionesSpigaAlmacenAlbaranBodegueroPorVendedor.CedulaVendedorRepuestos IN (52072959, 1110486801, 1121846131))
						   AND (dbo.vw_ComisionesSpigaAlmacenAlbaranBodegueroPorVendedor.FechaFactura <= '20191031') AND dbo.vw_ComisionesSpigaAlmacenAlbaranBodegueroPorVendedor.CedulaVendedorRepuestos NOT IN (52072959, 1110486801, 1121846131)
                          ...
                          GROUP BY dbo.vw_ComisionesSpigaAlmacenAlbaranBodegueroPorVendedor.CedulaVendedorRepuestos, dbo.vw_ComisionesSpigaAlmacenAlbaranBodegueroPorVendedor.NumeroFactura, 
                             ...
                             (SELECT        vw_ComisionesSpigaAlmacenAlbaranBodegueroPorVendedor_1.Ano_Periodo, vw_ComisionesSpigaAlmacenAlbaranBodegueroPorVendedor_1.Mes_Periodo, 
                                                         ...
                                                         AS CumplimientoAl15_AL_Sede, Sedes_1.CodigoSede, Sedes_1.NombreSede
                               ...
                               WHERE        
							   (DATEPART(DAY, vw_ComisionesSpigaAlmacenAlbaranBodegueroPorVendedor_1.FechaFactura) <= 15)
							   --AND (vw_ComisionesSpigaAlmacenAlbaranBodegueroPorVendedor_1.FechaFactura <= '20191031' OR vw_ComisionesSpigaAlmacenAlbaranBodegueroPorVendedor_1.CedulaVendedorRepuestos IN (52072959, 1110486801, 1121846131))
							   AND (vw_ComisionesSpigaAlmacenAlbaranBodegueroPorVendedor_1.FechaFactura <= '20191031') AND vw_ComisionesSpigaAlmacenAlbaranBodegueroPorVendedor_1.CedulaVendedorRepuestos NOT IN (52072959, 1110486801, 1121846131)

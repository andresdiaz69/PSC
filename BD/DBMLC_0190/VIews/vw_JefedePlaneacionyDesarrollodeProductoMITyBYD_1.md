# View: vw_JefedePlaneacionyDesarrollodeProductoMITyBYD_1
...
CREATE VIEW [dbo].[vw_JefedePlaneacionyDesarrollodeProductoMITyBYD_1] AS
...
(
	...
	(
		...
		(
			...
			WHERE (dbo.vw_RangosVersionesMaxSub.IdComisionModeloSub = 88) AND (dbo.vw_RangosVersionesMaxSub.IdComisionModeloSubCriterio = 167) 
		)AS EMPLEADOS
		LEFT JOIN 

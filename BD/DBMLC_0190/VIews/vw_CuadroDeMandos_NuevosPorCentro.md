# View: vw_CuadroDeMandos_NuevosPorCentro

## Usa los objetos:
- [[ComisionesSpigaVN]]

```sql
CREATE VIEW [dbo].[vw_CuadroDeMandos_NuevosPorCentro]
AS
SELECT        Ano_Periodo, Mes_Periodo, CodigoMArca, Marca, CodigoCentro, Centro,
...
GROUP BY Ano_Periodo, Mes_Periodo, CodigoMArca, Marca, CodigoCentro, Centro

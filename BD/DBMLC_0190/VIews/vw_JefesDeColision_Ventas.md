# View: vw_JefesDeColision_Ventas
...
```sql
CREATE view [dbo].[vw_JefesDeColision_Ventas] as
Select distinct a.CodigoPresentacion,p.nombrepresentacion,Año,Mes,CodigoConcepto,NombreConcepto,Sede,Valor
from(
		...
		where i.CodigoPresentacion in (91,92,97)
		--and i.año2 = 2020
		--and i.mesfinal2 in (5)
		and i.Balance = 17
		and i.mesinicial2 = MesFinal2
...
--and Año = 2024
--and mes=1
--and NombrePresentacion like '%ibag%'

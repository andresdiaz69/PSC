# View: v_GMF_2_ValoresCostosGastos
...
```sql
CREATE view [dbo].[v_GMF_2_ValoresCostosGastos] as
Select 
Empresa=case when a.CodigoPresentacion in (6,7,8,9,12,72,73,74) then 1 else 6 end,
a.CodigoPresentacion,p.nombrepresentacion,Año,Mes,CodigoConcepto,NombreConcepto,Sede,Valor
from(
		...
		and i.CodigoConcepto in (370,99,101,163,164,366)
		union all
		select i.CodigoPresentacion,Año=i.Año2,Mes=i.MesFinal2,i.CodigoConcepto,i.NombreConcepto,

# View: vw_BaseComisionesRepuestosBonaparte
...
```sql
--Base Comisiones de Jefe Nacional De Repuestos y Jefe de Accesorios Bonaparte
create view vw_BaseComisionesRepuestosBonaparte as
Select distinct a.CodigoPresentacion,a.NombrePresentacion,Año=Año2,MesInicial=MesInicial2,MesFinal = MesFinal2,
CodigoConcepto,NombreConcepto,Sede,--s.CodigoCentro,s.NombreCentro,
Valor
from(
...
-- left join InformesComiteDB.dbo.vw_InformesSedesCentros	s	on	a.CodigoPresentacion = s.CodigoPresentacion
--																		and a.sede = s.NombreSede
where Valor <> 0
and a.CodigoPresentacion = 59
--and a.año2 = 2021
--and a.MesFinal2 = 8
--and a.MesInicial2 = 8
--order by a.sede

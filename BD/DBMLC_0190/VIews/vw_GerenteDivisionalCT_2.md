# View: vw_GerenteDivisionalCT_2

## Usa los objetos:
- [[Empleados]]
- [[EmpleadosRangosMaestras]]
- [[vw_GerenteDivisionalCT_22]]
...
CREATE VIEW [dbo].[vw_GerenteDivisionalCT_2]
AS
SELECT        PESO_COMERCIAL.Ano_Periodo, PESO_COMERCIAL.Mes_Periodo, PESO_COMERCIAL.CodigoEmpleado, PESO_COMERCIAL.IdRangoMaestra, PESO_COMERCIAL.IdRangoVersionMax, PESO_COMERCIAL.CodigoMArca, 
                         ...
                         dbo.vw_RangosMaestrasFull.Hasta, dbo.vw_RangosMaestrasFull.Valor AS Comision_PesoComercial_DaimlerPC
FROM            (SELECT        dbo.vw_GerenteDivisionalCT_22.Ano_Periodo, dbo.vw_GerenteDivisionalCT_22.Mes_Periodo, dbo.vw_GerenteDivisionalCT_22.CodigoEmpleado, dbo.vw_GerenteDivisionalCT_22.CodigoMArca, 
                                                    dbo.vw_GerenteDivisionalCT_22.Marca,dbo.vw_GerenteDivisionalCT_22.EntregasEfectivas,dbo.vw_GerenteDivisionalCT_22.VentasNacionales, EMPLEADO.IdRangoMaestra, EMPLEADO.IdRangoVersionMax, EMPLEADO.IdComisionModeloSub, EMPLEADO.IdComisionModeloSubCriterio, 
                                                    dbo.vw_GerenteDivisionalCT_22.PesoComercial
                          FROM            (SELECT        dbo.Empleados.CodigoEmpleado, dbo.vw_RangosVersionesMaxSub.IdRangoMaestra, dbo.vw_RangosVersionesMaxSub.IdRangoVersionMax, dbo.vw_RangosVersionesMaxSub.IdComisionModeloSub, 
                                                    ...
                                                    WHERE        (dbo.vw_RangosVersionesMaxSub.IdComisionModeloSub = 47) AND (dbo.vw_RangosVersionesMaxSub.IdComisionModeloSubCriterio = 81)) AS EMPLEADO LEFT OUTER JOIN
                                                    dbo.vw_GerenteDivisionalCT_22 ON EMPLEADO.CodigoEmpleado = dbo.vw_GerenteDivisionalCT_22.CodigoEmpleado) AS PESO_COMERCIAL LEFT OUTER JOIN
                         dbo.vw_RangosMaestrasFull ON PESO_COMERCIAL.IdRangoVersionMax = dbo.vw_RangosMaestrasFull.IdRangoVersion
WHERE        (dbo.vw_RangosMaestrasFull.IdComisionModeloSub = 47) AND (dbo.vw_RangosMaestrasFull.IdComisionModeloSubCriterio = 81) AND (dbo.vw_RangosMaestrasFull.Desde < PESO_COMERCIAL.PesoComercial) AND 

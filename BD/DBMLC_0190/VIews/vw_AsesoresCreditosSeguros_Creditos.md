# View: vw_AsesoresCreditosSeguros_Creditos
...
CREATE view [dbo].[vw_AsesoresCreditosSeguros_Creditos] as
...
--from(
	...
	--and a.MesInicial2 = 5
	--order by a.sede
--)a group by CodigoPresentacion,NombrePresentacion,Año,MesInicial,MesFinal,

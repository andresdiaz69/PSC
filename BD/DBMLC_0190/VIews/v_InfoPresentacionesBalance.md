# View: v_InfoPresentacionesBalance
...
CREATE VIEW v_InfoPresentacionesBalance
AS
Select a.CodigoPresentacion,p.nombrepresentacion,Año,Mes,CodigoConcepto,NombreConcepto,Sede,Valor
from(
    ...
    --where i.CodigoPresentacion in (2,3,5,6,7,8,9,11,12,17,18,28,29,83,87,88,89,90)
    --and i.año2 = 2020
    --and i.mesfinal2 in (12)
    and i.Balance = 18
    and i.MesFinal1 <> MesFinal2
    and i.CodigoConcepto IN (225)
...
--where sede <> ' ' and Año = YEAR('20201201') and Mes = MONTH('20201201') and CodigoConcepto = 225

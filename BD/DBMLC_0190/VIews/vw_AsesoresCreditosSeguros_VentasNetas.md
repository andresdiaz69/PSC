# View: vw_AsesoresCreditosSeguros_VentasNetas
...
```sql
CREATE view [dbo].[vw_AsesoresCreditosSeguros_VentasNetas] as
--	Comisiones de VentasNetas
--Select distinct a.CodigoPresentacion,a.NombrePresentacion,Año,MesInicial,MesFinal,
--CodigoConcepto,NombreConcepto,Sede,CodigoCentro,NombreCentro,Valor=sum(valor)
--from(
...
--	and a.MesInicial2  = 3
	--order by a.sede
--)a group by a.CodigoPresentacion,a.NombrePresentacion,Año,MesInicial,MesFinal,
--CodigoConcepto,NombreConcepto,Sede,CodigoCentro,NombreCentro

# View: vw_ComercialVNPorCom_Liquidacion
...
```sql
CREATE VIEW [dbo].[vw_ComercialVNPorCom_Liquidacion]
AS
SELECT        dbo.vw_ComercialVNPorCom_1.Ano_Periodo, dbo.vw_ComercialVNPorCom_1.Mes_Periodo, dbo.vw_ComercialVNPorCom_1.CodigoEmpresa, dbo.vw_ComercialVNPorCom_1.Empresa, 
                         ...
                         SUM(dbo.vw_ComercialVNPorCom_1.ValorComision) AS ComisionRecaudo, SUM(dbo.vw_ComercialVNPorCom_1.ModeloVehSinComision) AS ModelosVehSinComision, dbo.RangosMaestras.IdRangoMaestra, 
...
GROUP BY dbo.vw_ComercialVNPorCom_1.Ano_Periodo, dbo.vw_ComercialVNPorCom_1.Mes_Periodo, dbo.vw_ComercialVNPorCom_1.CedulaVendedor, 
                         ...
                         dbo.RangosMaestras.IdComisionModeloSub, dbo.Empleados.CodigoEmpleado, dbo.Empleados.FechaRetiro, dbo.RangosMaestras.IdRangoMaestra
HAVING        (dbo.RangosMaestras.IdComisionModeloSub = 12) OR

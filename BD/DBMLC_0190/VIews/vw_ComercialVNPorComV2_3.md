# View: vw_ComercialVNPorComV2_3

## Usa los objetos:
- [[vw_ComercialVNPorComV2_2]]
...
CREATE VIEW [dbo].[vw_ComercialVNPorComV2_3]
AS
...
SELECT        Ano_Periodo, Mes_Periodo, Ano_Recaudo, Mes_Recaudo, FechaRecaudo, FechaEntregaCliente, FechaPeriodo, CodigoEmpresa, Empresa, CodigoCentro, Centro, FechaFactura, NumeroFactura, VIN, TotalFactura, 
                         ...
                         WHERE  
						 (vw_RangosMaestrasFull_Vehiculos.IdRangoMaestra = vw_ComercialVNPorComV2_2.IdRangoMaestra) AND 
						 (vw_RangosMaestrasFull_Vehiculos.IdRangoVersion = vw_ComercialVNPorComV2_2.IdRangoVersionMax) AND 
						 (vw_RangosMaestrasFull_Vehiculos.Desde_Precio < vw_ComercialVNPorComV2_2.PrecioBaseComision) AND 
						 (vw_RangosMaestrasFull_Vehiculos.Hasta_Precio >= vw_ComercialVNPorComV2_2.PrecioBaseComision) AND 
						 (vw_RangosMaestrasFull_Vehiculos.Desde_Unidades < vw_ComercialVNPorComV2_2.VehiculosRecaudados) AND 
                         (vw_RangosMaestrasFull_Vehiculos.Hasta_Unidades >= vw_ComercialVNPorComV2_2.VehiculosRecaudados)

# View: vw_AsesoresComercialesFinanciacionYSeguros_Usados_Liquidacion

## Usa los objetos:
- [[vw_AsesoresComercialesFinanciacionYSeguros_Usados_1]]
- [[vw_AsesoresComercialesFinanciacionYSeguros_Usados_2]]
- [[vw_EmpleadosDetalle]]

```sql


CREATE VIEW [dbo].[vw_AsesoresComercialesFinanciacionYSeguros_Usados_Liquidacion] AS
...
, ISNULL(ImporteFinanciado_1, 0) AS ImporteFinanciado_1, ISNULL(Financiacion_1, 0) AS Financiacion_1, ISNULL(Desde_1, 0) AS Desde_1, ISNULL(Hasta_1, 0) AS Hasta_1, ISNULL(ValorRango_1, 0) AS ValorRango_1, ISNULL(ValorComision_1, 0)AS ValorComision_1, 
ISNULL(ImporteFinanciado_2, 0) AS ImporteFinanciado_2, ISNULL(Desde_2, 0) AS Desde_2, ISNULL(Hasta_2, 0) AS Hasta_2, ISNULL(ValorRango_2, 0) AS ValorRango_2, ISNULL(ValorComision_2, 0)AS ValorComision_2, ISNULL(Comision_TOTAL, 0) AS Comision_TOTAL
...
(
	...
	FROM vw_AsesoresComercialesFinanciacionYSeguros_Usados_1 AS A
	FULL JOIN vw_AsesoresComercialesFinanciacionYSeguros_Usados_2 AS B ON
...
SELECT 
	 A.Ano_Periodo, A.Mes_Periodo, A.IdEmpresas, A.CodigoEmpleado, A.Nombres, '9999' AS IdTerceros, 'TOTAL' AS NombreFinanciera
...
WHERE Comision_TOTAL > 0 
-- JCS - 2022/09/21: 
-- DEBIDO AL PERFORMANCE SE DEBE FILTRAR A ESTE NIVEL PQ LA VISTA: vw_AsesoresComercialesFinanciacionYSeguros_Usados_1
-- SE DEGRADA SI SE LE APLICAN FILTROS
